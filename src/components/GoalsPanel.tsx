          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 grid gap-2 text-sm md:grid-cols-3">
              ...
              <div className="rounded-xl border border-border/60 bg-card/60 px-3 py-3">
                ...
                <p className="mt-1 font-semibold">{formatCurrency(goal.currentAmount)}</p>
              </div>
              <div className="rounded-xl border border-border/60 bg-card/60 px-3 py-3">
                <p className="text-xs uppercase tracking-[0.12em] text-muted-foreground">Zbývá</p>
                <p className="mt-1 font-semibold">{formatCurrency(remainingAmount)}</p>
              </div>
            </div>
      ...
      <DialogContent className="max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label>Aktuálně naspořeno při založení</Label>
              <Input
                type="number"
                value={currentAmount}
